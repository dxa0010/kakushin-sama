...
T.en = {
  ...
  ctrlHint2: "File a forgery and it is rejected in review ── and then, it comes.",
  ...
  // ---- 検分 ----
  inspectHint1: "Look closely. A forgery has exactly one thing that cannot be.",
  ...
  gagMycard: "Your identity card. The certificate expiry is…… safe.<br>Two months left. The PIN is four digits. Digits only, that one.",
  ...
  gagFake2: "A medical deduction statement…… on a closer look, it is last year's.<br>You typed the same four digits this time last year.<br>The one that is just a date, laid out in order.",
...
T["zh-Hans"] = {
  ...
  endSermonTag: "训话 结局",
  endSermonText: "被抓住了。<br><br>你在税务局被客客气气地训了三个小时。<br>经办人从头到尾都用着敬语。",
  endCityTag: "办事大厅 结局",
  endCityText: "身份证件被锁定了。<br>重新登记只能在办事大厅窗口办理。<br>办事大厅工作日九点到十七点。<br><br>今晚，你没能提交。",
...
T.ru = {
  ...
  gagMycard: "Удостоверение личности. Срок сертификата…… обошлось.<br>Оставалось два месяца. Код ── четыре знака. Только цифры, тот самый.",
  ...
  endLateText: "{deadlineNext}, 0:00.<br>{monster} молча склонило голову.<br>«Позвольте разъяснить порядок подачи с опозданием»<br><br>На вас наложен штраф за непредставление декларации.",
  endSermonTag: "КОНЦОВКА «НОТАЦИЯ»",
  endSermonText: "Пойманы.<br><br>Вам три часа вежливо читали нотацию в налоговой.<br>Инспектор до самого конца обращался на «вы».",
...
T.es = {
  ...
  gagMycard: "Tu documento de identidad. La validez del certificado…… a salvo.<br>Quedaban dos meses. El PIN es de cuatro dígitos. Solo números, ese de siempre.",
  ...
  endSermonText: "Atrapado.<br><br>Te sermonearon con toda educación durante tres horas en la delegación.<br>El funcionario te trató de usted hasta el final.",
