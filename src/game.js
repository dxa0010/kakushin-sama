...
function makeMonster() {
  ...
  for (const s of [-1, 1]) {
    ...
    rbox(0.134, 0.100, 0.232, 0.030, bodyDk, { x: an.x + s * 0.006, y: 0.052, z: an.z + 0.048, ry: s * 0.17, uv: 1.0 });
    sph(0.070, bodyDk, { x: an.x + s * 0.024, y: 0.050, z: an.z + 0.156, sx: 0.94, sy: 0.72, sz: 1.02 }, 18, 12);  // 丸いつま先
  }
  ...
  apronSheet(0.300, 0.332, 0.492, 0.975, 0.078, canvasM,
             { y: 0.768, z: 0.392, rx: 0.30, uv: 1.0 }, 0.60, 4, 0.014);
